<template>
  <div class="absolute bottom-10 left-16 right-16 flex justify-between items-end z-10 pointer-events-none text-[10px] font-bold tracking-[0.2em] uppercase text-white/60">
